...
void out_results_best_sol(const char *out_filename, char instance_name[], solution_data sol)
{
	FILE *fp;
	char buff[255];
...
void out_results_stat(int best, double ave, int worst, double avg_time, int hit, const char *stat_filename, const char *instance_name)
{
	FILE *fp;
	char buff[255];
